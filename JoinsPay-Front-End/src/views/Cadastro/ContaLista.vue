...
import {
  IContaListaView,
  IContaListaController,
} from "../../contracts/Cadastro/ContaListaContract";

import { ContaListaController } from "../../controllers/Cadastro/ContaListaController";
...
export default class ContaLista extends Vue implements IContaListaView {
  _controller?: IContaListaController;
  ...
  deleteItem(item: any) {
    this.itemContaDelete = item;
    this.dialogDelete = true;
  }

  deleteItemConfirmado() {
    this.dialogDelete = false;
    this._controller!.deleteitem(this.itemContaDelete.id);
  }

  editarItem(item: any) {
    this.$router.push("/Conta/" + item.id);
  }
  ...
  created() {
    ...
    this._controller = new ContaListaController(this);
